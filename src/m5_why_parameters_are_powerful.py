...
def main():
    ...
    # even_better_draw_circles(rg.Point(100, 50), 18, 10, 'red', 1)
    # even_better_draw_circles(rg.Point(-200, 0), 35, 5, 'blue', 5)

    even_better_draw_circles(rg.Point(0, 0), 60, 2, 'purple', 10)
    even_better_draw_circles(rg.Point(0, 0), 50, 2, 'blue', 10)
    even_better_draw_circles(rg.Point(0, 0), 40, 2, 'green', 10)
    even_better_draw_circles(rg.Point(0, 0), 30, 2, 'yellow', 10)
    even_better_draw_circles(rg.Point(0, 0), 20, 2, 'orange', 10)
    even_better_draw_circles(rg.Point(0, 0), 10, 2, 'red', 10)
    window.update()
...
def better_draw_circles(point, dr):
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(dr * k)  # Radius 15, 30, 45, 60, ...
